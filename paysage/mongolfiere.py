...
def mongolfiere(diametre_ballon, couleur_panier, couleur_ballon, couleur_sac):
    setPenWidth(2)
    setPenColor('black')
    hideTurtle()
    ...
    def sac_mongolfiere(couleur_sac):
    ...
    def sac_mongolfiere_deux(couleur_sac):
        right(90)
        forward(largeur_panier)
        left(90)
        penDown()
    ...
    sac_mongolfiere(couleur_sac)
    sac_mongolfiere_deux(couleur_sac)
    left(90)
...
if __name__ == '__main__':
    mongolfiere(100, 'brown', 'red', 'beige')
